$(document).ready(function() {
      ...
      $(window).scroll(function(){
           ...
           if(wScroll > $('#main-class').offset().top){
      ...
      $('.first-child').on('click', function(){
          var panel = $(this).attr('data-videoid');
          console.log(panel)
          $('.video-wrap').addClass('video-active');
          $('#'+panel).addClass('video-activee');
          $("body").addClass('bodyhidden')

          $('.video-black').on('click', function(){
            $('#'+panel).removeClass('video-activee');
